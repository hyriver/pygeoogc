...
Report bugs at https://github.com/hyriver/pygeoogc/issues.
...
PyGeoOGC could always use more documentation, whether as part of the
official PyGeoOGC docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/hyriver/pygeoogc/issues.
...
Ready to contribute? Here's how to set up pygeoogc for local development.
...
.. code-block:: console
    ...
    $ git remote add upstream git@github.com:hyriver/pygeoogc.git
