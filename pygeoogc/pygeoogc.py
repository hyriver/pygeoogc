...
class RESTfulURLs(NamedTuple):
    ...
    fema_prelim_cslf: str = "https://hazards.fema.gov/gis/nfhl/rest/services/CSLF/Prelim_CSLF/MapServer"
    fema_draft_cslf: str = "https://hazards.fema.gov/gis/nfhl/rest/services/CSLF/Draft_CSLF/MapServer"
